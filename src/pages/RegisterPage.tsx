...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // If email confirmation is enabled, the user won't be logged in immediately
        // and data.session might be null. You might want to show a "Check your email" message.
        // For now, we'll assume auto-login or redirect.
